            ...
            <div className='container my-4 p-4'>
                <div className="row align-items-center">
                    ...
                    <div className="col-12 col-sm-12 col-md-6 col-lg-6 about-col">
                        ...
                        <p className="p d-flex">
                            <span className="d-flex"><box-icon size='sm' className='text-xl' name='check-circle' color="#8067AD" style = {{width:'50px'}}></box-icon>  <p className="p-text">Brainstorming  - <span className="text-black">The team then conducts a brainstorming session with the founders on enhancing the concept of the product with a business plan</span>.</p></span>
                        </p>
                        <p className="p d-flex">
                            <span className="d-flex"><box-icon name='check-circle' color="#8067AD" style = {{width:'50px'}}></box-icon> <p className="p-text">Roadmap - <span className="text-black">The team develops a detailed plan of action that lays out the process of product development, Beta testing, User acquisition and fundraising.</span></p> </span> 
                        </p>
                        <p className="p d-flex">
                            <span className="d-flex"><box-icon name='check-circle' color="#8067AD" style = {{width:'50px'}}></box-icon> <p className="p-text">Evaluation  - <span className="text-black">Once all the stages have been finished successfully, we finally evaluate how the teams will work together to actualize the product</span></p> </span>
                        </p>
                    </div>
                </div>
            </div>
