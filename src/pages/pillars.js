                ...
                <div className="flex py-12" style={{
                    ...
                    <div className="my-modal">
                        <div style={{
                            ...
                            <box-icon style={{cursor: 'pointer'}} color='#8067AD' onClick={() => setShowModal(false)} name='x'></box-icon>
                        </div>
                        <div className="line" />
                        <div>
                            <h4 className="text-center event">Civic Engagement</h4>
                            <p>
        ...
        <div className="container my-4">
            <div className="row">
                ...
                <p className="h3 text-start event-title">Civic Engagement</p>
                    ...
                    <button className="btn-primary" onClick={() => setShowModal(true)}>Read More <box-icon style={{color: "#8067AD"}} name='right-arrow-alt' color='#8067AD'></box-icon></button>
                </div>
