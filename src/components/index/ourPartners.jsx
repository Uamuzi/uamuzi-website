...
import GillianNeky from "../../images/GillianNeky.webp";
  ...
  return (
    <div className='container my-5'>
        ...
        <a href="https://www.microsoft.com/en-us/startups" target="_blank" rel="noopener noreferrer">
          <img src={MS_Startups_FH} alt="microsoft logo" width={250} height={180} className='py-3 mb-5' />
        </a>

        <a href="https://careldevstudio.com/" target="_blank" rel="noopener noreferrer">
          <img src={CarelDevstudio} alt="carel devs tudio logo" width={250} height={180} className='py-3 mb-5' />
        </a>

        <a  href="https://nekyadvocates.com/" target="_blank" rel="noopener noreferrer">
          <img src={GillianNeky} alt="Gillian Neky logo" width={250} height={150} className='py-3 mb-5' />
        </a>
